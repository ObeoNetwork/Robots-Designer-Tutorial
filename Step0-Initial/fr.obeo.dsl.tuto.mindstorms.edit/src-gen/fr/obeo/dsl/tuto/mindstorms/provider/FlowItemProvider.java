...
/**
 * This is the item provider adapter for a {@link fr.obeo.dsl.tuto.mindstorms.Flow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FlowItemProvider extends InstructionItemProvider {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Flow_first_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Flow_first_feature", "_UI_Flow_type"),
				 MindstormsPackage.Literals.FLOW__FIRST,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MindstormsPackage.Literals.FLOW__INSTRUCTIONS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Flow.class)) {
			case MindstormsPackage.FLOW__INSTRUCTIONS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MindstormsPackage.Literals.FLOW__INSTRUCTIONS,
				 MindstormsFactory.eINSTANCE.createChoregraphy()));

		newChildDescriptors.add
			(createChildParameter
				(MindstormsPackage.Literals.FLOW__INSTRUCTIONS,
				 MindstormsFactory.eINSTANCE.createReuse()));
